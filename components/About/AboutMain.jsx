        ...
        <div className='relative flex flex-col lg:flex-row items-center justify-center min-h-screen h-full'>
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-2xl space-y-6 w-full lg:w-3/5">
            <div>
              ...
              <h2 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-light font-semibold mb-5 lg:mb-10'>Hi! I'm <span className='text-transparent bg-clip-text bg-gradient-to-r from-primary  to-light font-bold font-Montserrat'>Mahfuz Ahmed</span></h2>
              
              <div className='text-lg md:text-xl lg:text-2xl text-light font-semibold'>
                I am a
                <TypeAnimation
